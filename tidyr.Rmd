...
<center>
```{r, fig.cap="图片和后面的动图来自 https://www.garrickadenbuie.com/project/tidyexplain/#spread-and-gather "}
...
**names_prefix** 去除前缀 "wk"(否则无法从字符串转换为数值)，`names_ptype` 以列表的形式转换键列的数据类型。同理, **value_ptype** 可以转换值列的数据类型。  
