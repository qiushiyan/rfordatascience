...
#### When there is no identifying variable
...
```{r}
multi %>% 
  pivot_longer(-id, names_to = "name", values_to = "value", values_drop_na = TRUE) %>%
  mutate(checked = TRUE) %>% 
  pivot_wider(names_from = value, values_from = checked,
